...
const colorStyles: Record<
  FilterChipColor,
  { active: string; dismiss: string; toggle: { active: string; inactive: string } }
> = {
  blue: {
  ...
  gray: {
    ...
    toggle: {
      active:
        'bg-gray-200 border-gray-400 text-gray-700 dark:bg-gray-700 dark:border-gray-500 dark:text-gray-300',
      inactive:
        'border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700',
    },
  },
