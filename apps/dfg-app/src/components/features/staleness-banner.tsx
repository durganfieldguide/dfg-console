  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div>
          <p className="font-medium text-yellow-800 dark:text-yellow-200">Analysis is stale</p>
      ...
      <Button onClick={onReAnalyze} loading={isReAnalyzing} variant="warning" size="sm">
