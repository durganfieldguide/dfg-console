          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-mono text-gray-900 dark:text-white">{formatCurrency(result.breakdown.totalAllIn)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">Target ROI</span>
                <span className="font-mono text-gray-900 dark:text-white">{result.breakdown.targetRoiPctDisplay}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">Required Net Proceeds</span>
                <span className="font-mono text-gray-900 dark:text-white">{formatCurrency(result.requiredNetProceeds)}</span>
              </div>
              <div className="flex justify-between border-t border-gray-200 dark:border-gray-600 pt-2">
                <span className="text-gray-500 dark:text-gray-400">Listing Fees</span>
                <span className="font-mono text-gray-900 dark:text-white">−{formatCurrency(result.breakdown.listingFees)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">Payment Fees ({result.breakdown.paymentFeesPctDisplay})</span>
                <span className="font-mono text-gray-900 dark:text-white">−{formatCurrency(result.breakdown.paymentFees)}</span>
              </div>
              <div className="flex justify-between font-medium border-t border-gray-200 dark:border-gray-600 pt-2">
                ...
                <span className="font-mono text-gray-900 dark:text-white">{formatCurrency(result.requiredSalePrice)}</span>
              </div>
            </div>
