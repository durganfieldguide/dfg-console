  ...
  return (
    <div className={cn('space-y-4', className)}>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        >
          <div className="flex items-center gap-2 mb-2">
            <ChartBarIcon className={cn('h-5 w-5', demandInfo.color)} />
        ...
        >
          <div className="flex items-center gap-2 mb-2">
            <ClockIcon className="h-5 w-5" style={{ color: 'var(--muted-foreground)' }} />
            <span className="text-sm font-medium" style={{ color: 'var(--muted-foreground)' }}>
      ...
      {priceRange && (
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            <CurrencyDollarIcon className="h-5 w-5" style={{ color: 'var(--muted-foreground)' }} />
      ...
      {targetBuyers.length > 0 && (
        <div>
          <div className="flex items-center gap-2 mb-3">
            <UserGroupIcon className="h-5 w-5" style={{ color: 'var(--muted-foreground)' }} />
      ...
      {bestSellingPoints.length > 0 && (
        <div>
          <div className="flex items-center gap-2 mb-3">
            <BoltIcon className="h-5 w-5" style={{ color: 'var(--muted-foreground)' }} />
            ...
            >
              <div className="flex-1">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  {insight.trend === 'up' && <ArrowTrendingUpIcon className="h-4 w-4 text-green-600" />}
                  {insight.trend === 'down' && <ArrowTrendingDownIcon className="h-4 w-4 text-red-600" />}
                </div>
              </div>
            </div>
          ))}
