  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      {parsed.wasDowngraded && (
        ...
        >
          <ShieldExclamationIcon className="h-5 w-5 text-yellow-600 dark:text-yellow-400 flex-shrink-0 mt-0.5" />
          <div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          <ArrowTrendingUpIcon className="h-5 w-5" style={{ color: 'var(--muted-foreground)' }} />
